...
def test_data_preprocessor_standardize_columns(sample_raw_data):
    ...
    # Assert
    expected_cols = ['draw_date', 'white_ball_1', 'white_ball_2', 'white_ball_3', 'white_ball_4', 'white_ball_5', 'powerball']
...
def test_data_preprocessor_add_features():
    ...
    data = {
        ...
        'white_ball_1': [1, 10], 'white_ball_2': [2, 11], 'white_ball_3': [3, 12],
        'white_ball_4': [4, 13], 'white_ball_5': [5, 14], 'powerball': [6, 15]
    }
...
def test_start_training_job_success(mock_load_data, mock_trainer):
    ...
    mock_load_data.return_value = pd.DataFrame({
        ...
        'white_ball_1': [1], 'white_ball_2': [2], 'white_ball_3': [3],
    ...
    mock_trainer.agent.prepare_data.return_value = (
        ...
        (torch.randint(0, 69, (1, 5), dtype=torch.long), torch.randint(0, 26, (1,), dtype=torch.long)) # y data (targets)
    )
